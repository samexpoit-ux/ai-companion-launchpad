    ...
    <div className="relative">
      ...
      {open && result && (
        <div className="absolute right-0 top-8 z-30 w-96 overflow-hidden rounded-xl border border-ink-200 bg-white shadow-xl">
          <div className="flex items-center gap-2 border-b border-ink-200 px-3 py-2 text-[11px] text-ink-700">
            ...
            <button
              ...
              className="ml-auto inline-flex items-center gap-1 rounded-md border border-ink-200 px-1.5 py-0.5 text-[10px] text-ink-600 hover:bg-ink-50"
            >
              <RefreshCw className="h-2.5 w-2.5" />
              Re-run
            </button>
          </div>
          <ul className="max-h-64 overflow-auto p-2 font-mono text-[10.5px]">
